...
def get_capacity_status():
    return "FULL" if led_IR.value() == 1 else "EMPTY"
...
def main_page():
    ...
    led_IR_color = "red" if led_IR_status == "On" else "greenyellow"
        ...
        function updateStatus() {
            ...
            xhr.onreadystatechange = function() {
                if (xhr.readyState == 4 && xhr.status == 200) {
                    ...
                    var station2map = data.led_IR_status === "On" ? "red" : "greenyellow";
    ...
    <body class="background">
        ...
        <div class="img-pinsstation1 image-pins">
            <a href="station1.html">
                <div class="circle1" id="station1map" style="background-color:"""+ led_IR_color +""";padding:5%;"></div>
            </a>
        </div>
        <!--pin for station 2-->
        <div class="img-pinsstation2">
            <a href="station2.html">
                <div class="circle2" id="station2map" style="background-color: """+ led_IR_color +""";padding:5%;"></div>
            </a>
        </div>
        </div>
        </body>
...
def busstoplist():
        ...
        function updateStatus() {
            ...
            xhr.onreadystatechange = function() {
                if (xhr.readyState == 4 && xhr.status == 200) {
                    ...
                    var station1buzzer = data.led_IR_status === "On" ? "red" : "greenyellow";
                    document.getElementById("station1buzzer").style.backgroundColor = station1buzzer;
                    var station2map = data.led_IR_status === "On" ? "red" : "greenyellow";
                    document.getElementById("station2buzzer").style.backgroundColor = station2map;
    ...
    <div>
        <a href="station1.html">
          <div class="circle1" id="station1buzzer" style="background-color: """+ led_IR_color +""";padding:5%;"></div>
        </a>
        <h2 class="heading2">
            Station 1
        </h2>
    ...
    <div>
        <a href="station2.html">
          <div class="circle2" id="station2buzzer" style="background-color: """+ led_IR_color +""";padding:5%;"></div>
        </a>
        <h2 class="heading4">
            Station 2
        </h2>
        ...
        function updateStatus() {
            ...
            xhr.onreadystatechange = function() {
                if (xhr.readyState == 4 && xhr.status == 200) {
                    ...
                    document.getElementById("capacity_status").innerHTML = data.capacity_status;
    ...
    <title>
        ...
        <body>
            ...
            <p>
                ...
                <br>
                <br>
                Capacity: <strong id="capacity_status">""" + capacity_status + """</strong>
            </p>
...
def get_status():
    status = {
        ...
        "led_Temp1_status": led_Temp1_status,
        "led_Temp2_status": led_Temp2_status,
